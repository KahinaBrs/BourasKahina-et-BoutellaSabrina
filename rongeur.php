...
if(($_POST['sexe'])!='Sexe'){
        ...
        $inserer=$bdd->prepare("INSERT INTO rongeur(id,nom,race,age,sexe,apropos,img,validationadmin) VALUES(?,?,?,?,?,?,?,?)");
        $inserer->execute(array($idmembre,$nom,$race,$age,$sexe,$apropos,$picname,0));
        $move=move_uploaded_file($pictmpname,"rongeur/$picname");
        ...
        $message="vous avez oublié de mettre une image de votre rongeur !";}

         }else{
         $message="choisis le sexe de ton rongeur !";}
...
<head>
    ...
    <link rel="stylesheet" href="rongeur.css">
