...
if(($_POST['sexe'])!='Sexe'){
        ...
        $inserer=$bdd->prepare("INSERT INTO reptile(id,nom,race,age,sexe,apropos,img,validationadmin) VALUES(?,?,?,?,?,?,?,?)");
        $inserer->execute(array($idmembre,$nom,$race,$age,$sexe,$apropos,$picname,0));
        $move=move_uploaded_file($pictmpname,"reptile/$picname");
        ...
        $message="vous avez oublié de mettre une image de votre reptile !";}

         }else{
         $message="choisis le sexe de ton reptile !";}
