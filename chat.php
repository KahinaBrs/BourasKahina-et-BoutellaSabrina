...
if(($_POST['sexe'])!='Sexe'){
        ...
        $inserer=$bdd->prepare("INSERT INTO chat(id,nom,race,age,sexe,apropos,img,validationadmin) VALUES(?,?,?,?,?,?,?,?)");
        $inserer->execute(array($idmembre,$nom,$race,$age,$sexe,$apropos,$picname,0));
        $move=move_uploaded_file($pictmpname,"chat/$picname");
        ...
        $message="vous avez oublié de mettre une image de votre chat !";}

         }else{
         $message="choisis le sexe de ton chat !";}
