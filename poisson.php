...
if(($_POST['sexe'])!='Sexe'){
        ...
        $inserer=$bdd->prepare("INSERT INTO poisson(id,nom,race,age,sexe,apropos,img,validationadmin) VALUES(?,?,?,?,?,?,?,?)");
        $inserer->execute(array($idmembre,$nom,$race,$age,$sexe,$apropos,$picname,0));
        $move=move_uploaded_file($pictmpname,"poisson/$picname");
        ...
        $message="vous avez oublié de mettre une image de votre poisson !";}

         }else{
         $message="choisis le sexe de ton poisson !";}
